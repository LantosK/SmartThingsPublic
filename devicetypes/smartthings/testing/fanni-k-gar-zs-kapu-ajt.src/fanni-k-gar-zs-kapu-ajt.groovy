 ...
 */
metadata {
	definition (name: "Fanniék garázs kapu ajtó ", namespace: "smartthings/testing", author: "SmartThings") {
		capability "Actuator"
...
def open() {
    ...
    runIn(21, finishOpening)
}

def close() {
    sendEvent(name: "door", value: "closing")
	runIn(19, finishClosing)
}
...
private initialize() {
	...
	sendEvent(name: "DeviceWatch-Enroll", value: [protocol: "cloud", scheme:"untracked"].encodeAsJson(), displayed: enable)
}